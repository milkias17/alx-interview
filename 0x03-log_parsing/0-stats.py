...
org_status_code_count = {200: 0, 301: 0, 400: 0, 401: 0, 403: 0, 404: 0, 405: 0, 500: 0}


count = 0
total_file_size = 0
status_code_count = org_status_code_count.copy()
while True:
    try:
        line = input()
        ...
        if match:
            ...
            if cur_status_code in org_status_code_count.keys():
